...
'''
directories -> key value pair Files
'''
...
#function that displays the existing files
def existing_files(dictio):
    print("Following are the existing files")
    for key in dictio:
        print(key)

#function that displays the existing directories
...
#===================================================
'''
first takes the name and content from the user and after passing this to this function
will assign the file at unique key pair in root directory
'''
...
#==============================================
'''
this function asks for the file name and 
'''
...
while (rep==True):  
    ...
    if option==1:
        ...
        if(file_obj!=None):
            ...
            print('DIsplaying content of file 1 now')
